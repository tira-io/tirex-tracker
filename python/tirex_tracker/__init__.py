...
class Measure(IntEnum):
    ...
    TIME_START = 2
    TIME_STOP = 3
    TIME_ELAPSED_WALL_CLOCK_MS = 4
    TIME_ELAPSED_USER_MS = 5
    TIME_ELAPSED_SYSTEM_MS = 6
    CPU_USED_PROCESS_PERCENT = 7
    CPU_USED_SYSTEM_PERCENT = 8
    CPU_AVAILABLE_SYSTEM_CORES = 9
    CPU_ENERGY_SYSTEM_JOULES = 10
    CPU_FEATURES = 11
    CPU_FREQUENCY_MHZ = 12
    CPU_FREQUENCY_MIN_MHZ = 13
    CPU_FREQUENCY_MAX_MHZ = 14
    CPU_VENDOR_ID = 15
    CPU_BYTE_ORDER = 16
    CPU_ARCHITECTURE = 17
    CPU_MODEL_NAME = 18
    CPU_CORES_PER_SOCKET = 19
    CPU_THREADS_PER_CORE = 20
    CPU_CACHES = 21
    CPU_VIRTUALIZATION = 22
    RAM_USED_PROCESS_KB = 23
    RAM_USED_SYSTEM_MB = 24
    RAM_AVAILABLE_SYSTEM_MB = 25
    RAM_ENERGY_SYSTEM_JOULES = 26
    GPU_SUPPORTED = 27
    GPU_MODEL_NAME = 28
    GPU_AVAILABLE_SYSTEM_CORES = 29  # aka. GPU_NUM_CORES
    GPU_USED_PROCESS_PERCENT = 30
    GPU_USED_SYSTEM_PERCENT = 31
    GPU_VRAM_USED_PROCESS_MB = 32
    GPU_VRAM_USED_SYSTEM_MB = 33
    GPU_VRAM_AVAILABLE_SYSTEM_MB = 34
    GPU_ENERGY_SYSTEM_JOULES = 35
    GIT_IS_REPO = 36
    GIT_HASH = 37
    GIT_LAST_COMMIT_HASH = 38
    GIT_BRANCH = 39
    GIT_BRANCH_UPSTREAM = 40
    GIT_TAGS = 41
    GIT_REMOTE_ORIGIN = 42
    GIT_UNCOMMITTED_CHANGES = 43
    GIT_UNPUSHED_CHANGES = 44
    GIT_UNCHECKED_FILES = 45
    PYTHON_VERSION = 1000
