...
static const char* measureToName[] = {
		...
		[MSR_CPU_CACHES_L1_KB] = "cpu caches l1 kb",
		[MSR_CPU_CACHES_L2_KB] = "cpu caches l2 kb",
		[MSR_CPU_CACHES_L3_KB] = "cpu caches l3 kb",
		[MSR_CPU_VIRTUALIZATION] = "cpu virtualization",
		[MSR_CPU_BOGO_MIPS] = "cpu bogo mips",
		...
		[MSR_GPU_AVAILABLE_SYTEM_CORES] = "gpu available sytem cores",
...
int main(int argc, char* argv[]) {
	...
	const msrMeasureConf providers[] = {
			...
			{MSR_CPU_CACHES_L1_KB, MSR_AGG_NO},
			{MSR_CPU_CACHES_L2_KB, MSR_AGG_NO},
			{MSR_CPU_CACHES_L3_KB, MSR_AGG_NO},
			{MSR_CPU_VIRTUALIZATION, MSR_AGG_NO},
			{MSR_CPU_BOGO_MIPS, MSR_AGG_NO},
			...
			{MSR_GPU_AVAILABLE_SYTEM_CORES, MSR_AGG_NO},
