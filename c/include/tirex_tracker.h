 ...
 */
TIREX_TRACKER_EXPORT void tirexResultFree(tirexResult* result);
/** @} */ // end of tirexresult
 ...
 */
TIREX_TRACKER_EXPORT size_t tirexDataProviderGetAll(tirexDataProvider* providers, size_t bufsize);
/** @} */ // end of dataprovider
 ...
 * @return TIREX_SUCCESS on success or an error code. 
 */
TIREX_TRACKER_EXPORT tirexError tirexMeasureInfoGet(tirexMeasure measure, const tirexMeasureInfo** info);
/** @} */ // end of measureinfo
#ifdef __cplusplus
}
#endif
